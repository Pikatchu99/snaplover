...
export function SiteCredit() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-50 flex flex-wrap items-center justify-center gap-x-3 gap-y-1 bg-black/70 px-3 py-1.5 text-center text-[11px] text-white/80 backdrop-blur-sm">
      <span>
